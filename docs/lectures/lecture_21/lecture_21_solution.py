...
def main():
    ...
    solo = Person(swapi_solo['name'], swapi_solo['url'])
    ...
    # UNCOMMENT
    # write_json(filepath, m_falcon.jsonable()) # raises TypeError exception
