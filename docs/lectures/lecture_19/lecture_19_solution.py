...
def main():
    ...
    # 1.0 INITIALIZE
    jedi = Jedi('Jedi', 5, TheForce.aspects[0])
    sith = Sith('Sith', 5, TheForce.aspects[1])
    ...
    while jedi.strength > 0 and sith.strength > 0:
        ...
        jedi.wield_lightsaber((move, aim, jedi.force))

        # 1.2.3 Sith wields lightsaber
        random_move, random_aim = game.random_saber_action() # unpack
        sith.wield_lightsaber((random_move, random_aim, sith.force))
