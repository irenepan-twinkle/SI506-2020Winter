...
def place_in_standings(standings, team):
    ...
    for i in range(standings_count):
        if team['points'] >= standings[i]['points']:
            ...
            standings.append(team) # last place team
        else:
            continue
...
def main():
    ...
    # Test multiple tie conditions (3+)
    # premier_league = {
    #     'Arsenal': [8,13,6],
    #     'Aston Villa': [7,4,16],
    #     'Bournemouth': [7,5,15],
    ...
    #     'Everton': [10,6,11],
    #     'Leicester City': [15,5,7],
    #     'Leicester City_01': [15,5,7],
    #     'Leicester City_02': [15,5,7],
    #     'Liverpool': [26,1,0],
    #     'Manchester City': [18,3,6],
    #     'Manchester United': [11,8,8],
    #     'Newcastle': [8,7,12],
    ...
    #     'West Ham': [6,6,15],
    #     'Wolverhampton': [9,12,6],
    #     'Wolverhampton_1': [9,12,6],
    #     'Wolverhampton_2': [9,12,6],
    #     'Wolverhampton_3': [9,12,6]
    # }
