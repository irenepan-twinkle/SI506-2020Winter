...
# PROBLEM 5: (20 points)
def find_common_words(frequency_dictionary,cutoff):
    """
...
def main(poem):
    ...
    common_words = find_common_words(freq_dict,3)
...
if __name__ == "__main__":
    ...
    print(f"\nThe final result of problems 3, 4, 5, and 6: {result}")
